...
//    public static int saveToGalleryFlags;
    ...
    public static void checkSaveToGalleryFiles() {
        Utilities.globalQueue.postRunnable(() -> {
            try {
                File telegramPath = new File(Environment.getExternalStorageDirectory(), "GOmessenger");
                File imagePath = new File(telegramPath, "GOmessenger Images");
                imagePath.mkdir();
                File videoPath = new File(telegramPath, "GOmessenger Video");
                videoPath.mkdir();
